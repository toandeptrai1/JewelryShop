              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="/JewelryShop/quan-tri/product/uploadFile" enctype="multipart/form-data" method="post">
                   ...
                   <form method="post" action="/JewelryShop/quan-tri/product/add">
                   <div class="row mb-3">
                      	   ...
                      	   <option value="1" >Đồng hồ</option>
                   	       ...
                   	       <option value="3">Bông tai</option>
                  	         <option value="4">Dây chuyền</option>
                  	           <option value="5" selected>Vòng cổ</option>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="pname" type="text" class="form-control" id="fullName" value="">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="price" type="text" class="form-control" id="Address" value="">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="desc" type="text" class="form-control" id="Phone" value="">
                      </div>
                    </div>

                    
                    <input name="id" type="hidden" class="form-control" id="Email" value="">
                    <c:choose>
                      		<c:when test="${FileName!=null}">
                      			   
                      			    <input name="img"  class="form-control" id="Email" value="${FileName}">
                      		</c:when>
                      		<c:otherwise>
                      			
                      			<input name="img"  class="form-control" id="Email" value="">
                      		</c:otherwise>
                     </c:choose>
